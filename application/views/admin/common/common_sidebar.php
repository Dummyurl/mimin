          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="<?php echo site_url("admin/registers"); ?>">
                <i class="fa fa-users"></i> <span> <?php echo $this->lang->line("App Registers");?></span> <small class="label pull-right bg-green"></small>
              </a>
            </li>
            <li>
           ...
           <li>
            ...
            <li>
              <a href="<?php echo site_url("admin/laporan"); ?>">
                <i class="fa fa-bar-chart"></i> <span> <?php echo $this->lang->line("Report");?></span> <small class="label pull-right bg-green"></small>
              </a>
            </li>
             <li>
              <a href="#">
