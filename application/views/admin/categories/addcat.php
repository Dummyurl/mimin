                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cat_title" class="form-control" placeholder="Judul Kategori"/>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" class="btn btn-primary" name="addcatg" value="Tambah Kategori" />
