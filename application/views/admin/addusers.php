...
<html>
  <head>
    ...
    <title>Admin | Tambah Sales</title>
      ...
      <div class="content-wrapper">
                ...
                <!-- Content Header (Page header) -->
                 <section class="content-header">
                    <h1>
                         <?php echo $this->lang->line("Sales Name"); ?>
                        <small> <?php echo $this->lang->line("Preview"); ?></small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i>  <?php echo $this->lang->line("Home"); ?></a></li>
                        <li><a href="#"> <?php echo $this->lang->line("Sales Name"); ?></a></li>
                        <li class="active"> <?php echo $this->lang->line("Add Sales"); ?></li>
                    </ol>
                </section>
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label class="">  <?php echo $this->lang->line("Username"); ?><span class="text-danger">*</span></label>
                                            <input type="text" name="user_name" class="form-control" placeholder="Username"/>
                                        </div>
                                       <div class="form-group">
                                            <label class="">  <?php echo $this->lang->line("No Hp"); ?><span class="text-danger">*</span></label>
                                            <input type="text" name="user_mobile" class="form-control" placeholder="No Hp"/>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" class="btn btn-primary" name="addusers" value="Tambah Sales" />
