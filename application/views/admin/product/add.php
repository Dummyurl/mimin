                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label class=""><?php echo $this->lang->line("Product Title :");?> <span class="text-danger">*</span></label>
                                                    <input type="text" name="prod_title" class="form-control" placeholder="Nama Produk"/>
                                         </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="product_description" class="textarea" placeholder="Tulis Deskripsi Disini" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
