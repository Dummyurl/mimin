    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <?php echo $this->lang->line("Report Kunjungan");?>
          </h1>
          <form action="" method="post">
           ...
           <ol class="breadcrumb">
                        ...
                        <li><a href="#"><?php echo $this->lang->line("Report Kunjungan");?></a></li>
         ...
         <div class="row">
          ...
          <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th><?php echo $this->lang->line("Jumlah Kunjungan");?></th>
                    <th><?php echo $this->lang->line("Target Kunjungan");?></th>
                    <th><?php echo $this->lang->line("Persentase Kunjungan");?></th>
                </tr>
                </thead>
          <tbody>
          <?php
          foreach($users as $user)
          {
            ?>
                <tr>
                    ...
                    if ($total_orders AND $target != 0) {
                        $persen = ($user->total_orders)/($user->target)*100;
                        echo "$persen %";
                    }
                    ?>
                    </strong></td>
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                            ...
                            data: [<?php foreach($users as $user) echo $user->total_orders.','; ?>],
                           backgroundColor: [
                                'rgba(255, 99, 132, 1)',
                                'rgba(54, 162, 235, 1)',
                                'rgba(255, 206, 86, 1)',
