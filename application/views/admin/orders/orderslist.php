                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title"> <?php echo $this->lang->line("Order");?></h3> <br>
          ...
          <form action="" method="post">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th> <?php echo $this->lang->line("Sales Phone");?></th>
          ...
          foreach($today_orders as $order)
          {
            ?>
                <tr>
                    ...
                    <td><a href="<?php echo site_url("admin/orderdetails/".$order->sale_id); ?>" class="btn btn-sm btn-default"> <?php echo $this->lang->line("Detail");?></a>
    </td>
    <td>
    <div class="dropdown">
