...
<html>
  <head>
    ...
    <title>Admin | Hasil Kunjungan</title>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title"> <?php echo $this->lang->line("Hasil Kunjungan");?></h3> <br>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo $this->lang->line("Target Kunjungan");?>  </th>
                                        ...
                                        <tbody>
                                           <?php foreach($today_kunjungan as $task){ ?>
                                            <tr>
                                                 ...
                                                 <td><?php echo $task->nama_sales; ?></td>
                                                <td><?php echo $task->list_kunjungan; ?></td>
                                                <td><?php echo $task->waktu; ?></td>
                                                 <td class="text-center"><div class="btn">
                                                        <?php echo anchor('admin/deletekun/'.$task->id_target_kunjungan, '<i class="fa fa-trash"></i>', array("class"=>"btn btn-danger", "onclick"=>"return confirm('Are you sure delete?')")); ?>
